...
public class SocketModel {
	...
	// 전송[SS] 공통[9] + 시퀀스[10] + 데이터[1~5101] = 19 + [1~5101] = 20~5120
	// 시퀀스[10]
	private int msgSeq = 0;

	// 확인요구[SC] 공통[9] + 시퀀스[10] + 보낸크기[20] = 39
	// 보낸 시퀀스
	private int sendSeq = 0;
	// 보낸 파일 크기
	private long sendSize = 0;

	// 확인응답[RC] 공통[9] + 시퀀스[10] + 받은크기[20] = 39
	// 받은 시퀀스
	private int recvSeq = 0;
	// 받은 파일 크기
	private long recvSize = 0;

	// 종료요구[SE] 공통[9] + 시퀀스[10] + 보낸크기[20] = 39
	// 종료요구[RE] 공통[9] + 시퀀스[10] + 받은크기[20] = 39
